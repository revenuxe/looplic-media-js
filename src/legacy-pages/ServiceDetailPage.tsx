...
const getSlugFromLocation = () => {
  ...
  return parts[0] === "services" ? parts[1] : undefined;
};

const ServiceDetailPage = ({ slug }: ServiceDetailPageProps) => {
  const resolvedSlug = slug || getSlugFromLocation();
  const detail = resolvedSlug ? serviceDetails[resolvedSlug] : null;
      ...
      <div className="min-h-screen bg-background">
        ...
        <div className="flex items-center justify-center py-32">
          <div className="text-center">
            ...
            <AppLink to="/services" className="text-accent underline">Browse all services</AppLink>
          </div>
        </div>
      </div>
    );
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="relative">
        <div className="bg-secondary pt-10 sm:pt-16 pb-24 sm:pb-32 px-4 sm:px-6 lg:px-12 relative overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto relative z-10">
            <AppLink to="/#service" className="text-accent text-sm font-medium uppercase tracking-wider">← Services</AppLink>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 -mt-16 sm:-mt-20 relative z-20">
          <div className="rounded-lg sm:rounded-2xl overflow-hidden shadow-2xl">
            <img src={assetSrc(image)} alt={detail.title} width={1920} height={1080} className="w-full h-[200px] sm:h-[300px] md:h-[500px] object-cover" />
          </div>
      ...
      <SeoAnswerSummary
        ...
        title={`${detail.title} by Looplic`}
        answer={`Looplic provides ${detail.title.toLowerCase()} for brands that need polished, platform-ready content with strategy, production, post-production and performance variants handled by one team.`}
        points={[
          detail.useCases[0],
          detail.deliverables[0],
          "Built for paid ads, social media and brand growth",
        ]}
      />
