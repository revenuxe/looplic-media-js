      ...
      <div className="bg-secondary pt-10 sm:pt-16 pb-24 sm:pb-32 px-4 sm:px-6 lg:px-12 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <p className="mt-6 text-base sm:text-lg text-muted-foreground max-w-2xl">
            Looplic is an AI media &amp; ad film production company building cinematic AI videos, UGC ads, product shoots and brand films for D2C, SaaS and modern brands — 10x faster, at a fraction of the cost.
          </p>
        </div>
      </div>
